                ...
                <div class="text-center">
                    @if ($booking != null)
                        <div class="card border-0 rounded-3" style="border-radius: 10px; ">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-4 border border-info"><img src="/bmwlogo.gif" alt=""
                                            class="w-75">
                                    ...
                                    <div class="col-4 border border-info"><img src="/notepad.gif" alt=""
                                            class="w-75">
                                    ...
                                    <div class="col-4 border border-info"><img src="/date.gif" alt=""
                                            class="w-75">
                        ...
                        <div class="card" style="opacity: 0.5">
                            <div class="card-body">
                                <div class="row text-center d-flex justify-content-center">
                                    ...
                                    <div class="text-center" style="font-size: 30px;">Tidak Ada Booking Dalam Waktu
                                        Dekat
                                    </div>
                                </div>
                                <div class="row d-flex justify-content-center">
                                    <div class="col-2 m-3"><a href="/"><button class="btn-secondary"
                                                style="opacity: 100%">Buat
                                                Booking</button></a></div>
                                </div>
                            </div>
                        </div>
                    @endif
