...
<div class="container-fluid pb-3 flex-grow-1 d-flex flex-column flex-sm-row overflow-auto">
 ...
 <a href="" onClick="this.href='/exportpdf/'+document.getElementById('datedialyReport').textContent"style="background-color: #008CBA; color: white; padding: 10px 20px; border: none; cursor: pointer;">Export to PDF</a>  <button id="" style="background-color: #008CBA; color: white; padding: 10px 20px; border: none; cursor: pointer;" 
  >
                </div>
            </div>
